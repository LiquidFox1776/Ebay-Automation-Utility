...
(function() {
 ...
 function tb(a, b, d) {
  if (a.c == H) {
   if (a == d) b = I, d = new TypeError("Promise cannot resolve to itself");
   else {
    if (cb(d)) {
     a.c = 1;
     Ab(d, a.ka, a.la, a);
 ...
 function Zb(a, b, d, e, f, g) {
  ...
  b = a.c[h];
  b || (b = a.c[h] = [], a.f++);
  var k = $b(b, d, f, g); - 1 < k ? (a = b[k], e || (a.$ = !1)) : (a = new Wb(d, a.src, h, !!f, g), a.$ = e, b.push(a));
  return a
 }
 ...
 function ec(a, b, d, e, f) {
  if (ca(b))
   for (var g = 0; g < b.length; g++) ec(a, b[g], d, e, f);
  else if (d = fc(d), a && a[Ub]) Zb(a.D, String(b), d, !1, e, f);
  else {
 ...
 function kc(a, b, d, e, f) {
  if (ca(b))
   for (var g = 0; g < b.length; g++) kc(a, b[g], d, e, f);
  else(d = fc(d), a && a[Ub]) ? (a = a.D, b = String(b).toString(), b in a.c && (g = a.c[b], d = $b(g, d, e, f), -1 < d && (Xb(g[d]), B.splice.call(g, d, 1), 0 == g.length && (delete a.c[b], a.f--)))) : a && (a = gc(a)) && (b = a.c[b.toString()], a = -1, b && (a = $b(b, d, !!e, f)), (d = -1 < a ? b[a] : null) && lc(d))
 }
 ...
 function K(a, b) {
  ...
  var e = a.na,
   ...
   g = f.type || f;
  if (q(f)) f = new Rb(f, e);
  else if (f instanceof Rb) f.target = f.target || e;
  else {
   var h = f,
    f = new Rb(g, e);
   Ga(f, h)
  ...
  var h = !0,
   k;
  if (d)
   for (var m = d.length - 1; 0 <= m; m--) k = f.c = d[m], h = pc(k, g, !0, f) && h;
  k = f.c = e;
  h = pc(k, g, !0, f) && h;
  h = pc(k, g, !1, f) && h;
  if (d)
   for (m = 0; m < d.length; m++) k = f.c = d[m], h = pc(k, g, !1, f) && h
 }
 ...
 function yc(a, b) {
  ...
  else if (da(a) || q(a)) sa(a, b, void 0);
  else {
   var d;
 ...
 var Ic = new Hc("SEVERE", 1E3),
  Jc = new Hc("WARNING", 900),
  Kc = new Hc("INFO", 800),
  Lc = new Hc("CONFIG", 700),
  Mc = new Hc("FINE", 500);
 ...
 Gc.prototype.log = function(a, b, d) {
  if (a.value >= Nc(this).value)
   for (t(b) && (b = b()), a = new Ec(a, String(b), this.i), d && (a.c = d), d = "log:" + a.f, n.console && (n.console.timeStamp ? n.console.timeStamp(d) : n.console.markTimeline && n.console.markTimeline(d)), n.msWriteProfilerMark && n.msWriteProfilerMark(d), d = this; d;) d = d.f
 };
 var Oc = {},
  Pc = null;
 ...
 function od(a) {
  if (a.f && "undefined" != typeof aa)
   if (a.H[1] && 4 == pd(a) && 2 == a.w()) L(a.v, M(a, "Local request error detected and ignored"));
   else if (a.s && 4 == pd(a)) qc(a.ga, 0, a);
  else if (K(a, "readystatechange"), 4 == pd(a)) {
   L(a.v, M(a, "Request complete"));
   a.f = !1;
   try {
    if (qd(a)) K(a, "complete"), K(a, "success");
    else {
     var b;
     try {
 ...
 function Fd(a, b) {
  ...
  if (g) td(f, e.s);
   ...
   if ("/" != h.charAt(0) && (d.c && !d.f ? h = "/" + h : (d = f.f.lastIndexOf("/"), -1 != d && (h = f.f.substr(0, d + 1) + h))), d = h, ".." == d || "." == d) h = "";
   else if (A(d, "./") || A(d, "/.")) {
 ...
 l.toString = function() {
  ...
  for (var a = [], b = this.c.I(), d = 0; d < b.length; d++)
   for (var e = b[d], f = encodeURIComponent(String(e)), e = this.J(e), g = 0; g < e.length; g++) {
    var h = f;
 ...
 function Pd(a) {
  if (window.localStorage)
   if (a) window.localStorage.ServicePort = a;
   else try {
    delete window.localStorage.ServicePort
   } catch (b) {} else Ld() ? a ? Md("ServicePort", a, 100) : Md("ServicePort", "", 100) : window.c = a
 }
 ...
 function Zd() {
  ...
  this.openLabelFile = function(a) {
   return Yd("GET", "OpenLabelFile", {
    fileName: a
   })
  };
  this.printLabel = function(a, b, d, e) {
   return Yd("POST", "PrintLabel", {
    printerName: a,
    printParamsXml: b,
    labelXml: d,
    labelSetXml: e
  ...
  this.loadImageAsPngBase64 = function(a) {
   return Yd("GET", "LoadImageAsPngBase64", {
    imageUri: a
   })
  };
  this.T = function() {
  ...
  this.V = function(a) {
   return Xd("GET", "OpenLabelFile", {
    fileName: a
   })
  };
  this.X = function(a, b, d, e) {
   return Xd("POST", "PrintLabel", {
    printerName: a,
    printParamsXml: b,
    labelXml: d,
    labelSetXml: e
  ...
  this.U = function(a) {
   return Xd("GET", "LoadImageAsPngBase64", {
    imageUri: a
   })
  }
 };
 ...
 */
 ...
 ve.prototype.cancel = function(a) {
  if (this.c) this.h instanceof ve && this.h.cancel();
  else {
   if (this.f) {
    var b = this.f;
    delete this.f;
 ...
 function kf(a, b) {
  var d = a.h(),
   e = a.f,
   f = a.c.C;
  (new Me(Fd(f, "getPrintJobStatus"), "callback")).send({
   jobId: e,
   printerName: a.c.c
  }, function(a) {
 ...
 function ef(a, b) {
  function d() {
   ...
   if (-1 != b.indexOf("Win"))
    ...
    } else O("checkLegacyPlugins > non-IE"), f.isBrowserSupported = !0, We("application/x-dymolabel") ? (O("checkLegacyPlugins > 'application/x-dymolabel'"), f.isFrameworkInstalled = !0) : f.errorDetails = "DYMO Label Framework Plugin is not installed";
 ...
 function nf(a) {
  ...
  for (var e = U(d, "Printers"), d = e.getElementsByTagName("LabelWriterPrinter"), f = 0; f < d.length; f++) {
   var g = b(d[f], "Name"),
    ...
    m = "True" == b(d[f], "IsLocal"),
    r = "True" == b(d[f], "IsTwinTurbo"),
    g = new gf(g, h, k, m, r);
   a[f] = g;
   a[g.name] = g
  }
  ...
  for (f = 0; f < r.length; f++) {
   var g = b(r[f], "Name"),
    h = b(r[f], "ModelName"),
    k = "True" == b(r[f], "IsConnected"),
    m = "True" == b(r[f], "IsLocal"),
    z = "True" ==
    b(r[f], "IsAutoCutSupported"),
    g = new hf(g, h, k, m, z);
   a[f + d.length] = g;
   a[g.name] = g
  }
 ...
 function of() {
  ...
  for (var e in lf)
   for (var b = lf[e].getPrinters(), f = 0; f < b.length; ++f) {
    var g = b[f];
    a.push(g);
    a[g.name] = g
   }
 ...
 function je(a, b, d, e) {
  ...
  var f = of()[a];
  if (null != f) "" != f.C ? sf(f, b, d, e) : P().printLabel(f.name, b, d, e);
